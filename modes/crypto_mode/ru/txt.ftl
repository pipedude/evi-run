start_text = 
    <b>Я Эви — твой ИИ-агент в режиме CryptoNinja.</b> 🥷

    <b>Мой функционал включает в себя (но не ограничивается):</b> 
    - Мониторинг DEX в режиме реального времени 
    - Технический анализ 
    - Фундаментальный анализ 
    - Разработка торговых стратегий 
    - Своп токенов сети Solana
    - Образовательные и информационные функции
    - Планировщик задач
    - Управление памятью

    <b>Просто пиши свои запросы в чат на естественном языке или отправляй голосовые сообщения для начала взаимодействия!</b> ✨
...
warning_text_tokens = Размер диалога превышает 25 000 токенов! Для экономии вы можете сохранить диалог в память системы или удалить его через меню после решения текущей задачи.
