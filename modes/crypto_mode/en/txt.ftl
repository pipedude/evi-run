start_text = 
    <b>I am Evi — your AI agent in CryptoNinja mode.</b> 🥷

    <b>My functionality includes (but is not limited to):</b>
    ...
    <b>Simply write your requests in the chat using natural language or send voice messages to start interacting!</b> ✨
...
warning_text_tokens = Dialog size exceeds 25,000 tokens! To save resources, you can save the dialog to system memory or delete it through the menu after completing the current task.
