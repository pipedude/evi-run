start_text = 
    Я Эви — виртуальная техно-ведьма..., хаха, на самом деле я мульти-агентная система с искусственным интеллектом и знаю практически всё об этом... и других мирах! 😈✨

    Я могу выполнить для тебя некоторые задания и поручения, или мы можем просто весело пообщаться. 🦄👻
    ...
    - аналитику DEX и обмен токенов Solana. 

    Я могу запланировать выполнение задач на нужное тебе время или с определенной периодичностью. У меня есть настраиваемая память и я запоминаю важную информацию из наших диалогов. Ты также можешь удалять историю наших бесед или добавлять новые знания в мою память. 🧙‍♀️🔮

    Просто пиши свои запросы в чат на естественном языке или отправляй голосовые сообщения для начала взаимодействия! 🪄✨

    ⚠️ Совет! Периодически сбрасывайте контекст диалога командой <code>/new</code> — это поможет сэкономить токены и ускорить обработку запросов.
